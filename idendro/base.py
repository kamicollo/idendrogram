...
class IDendro:
    ...
    def __init__(
        ...
        Args:
            ...
            node_factory (Callable[[Dict], ClusterNode]): [idendro.ClusterNode][] factory that can be used to override node formatting defaults.                 

            axis_label_factory (Callable[[Dict], AxisLabel]): [idendro.AxisLabel][] factory that can be used to override axis label formatting defaults.                 
    ...
    def convert_scipy_dendrogram(
        ...
        Args:
            ...
            compute_nodes: Whether to compute nodes (requires [idendro.ClusteringData][] to be set via [idendro.IDendro.set_cluster_info][] and can be computationally expensive on large datasets).            

            node_label_func (Callable[[], str], optional): Callback function to generate dendrogram node labels. See [idendro.IDendro.create_dendrogram][] for usage details.

            node_hover_func (Callable[[], Union[Dict, str]], optional): Callback function to generate dendrogram hover text labels. See [idendro.IDendro.create_dendrogram][] for usage details.

...
def cluster_labeller(
    ...
    """Returns a callable designed to be used as a callback to `axis_label_func` parameter of [idendro.IDendro.create_dendrogram][]. 
    ...
    Returns:
        Callable[[ClusteringData, int], str]: Callable designed to be used as a callback to to `axis_label_func` parameter of [idendro.IDendro.create_dendrogram][].
    """
...
def link_painter(
    ...
    Returns:
        Callable[[ClusteringData, int], str]: Callable to be used as `link_color_func` argument of [idendro.IDendro][].
    ...
    Example:
        ```
            ...
            painter = idendro.callbacks.link_painter(
                colors={
                    1: 'red',
                    2: 'blue',
                    3: 'green',
